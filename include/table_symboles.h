...
/**
 * Structure pour un nœud de la liste chaînée dans la table de hachage (pile de
 * blocks)
 */
...
/**
 * Création d'une nouvelle pile d'identificateur et la placer dans la pile
 * globale
 */
void stack_id_push(struct table_hachage_t *current_stack);

/**
 * Libérer l'espace de la structure struct stack_id et des identificateurs id_t
 * et libérer de la pile
 */
